...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BroughLike", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BroughLike", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "BroughLike";
		app.meta["name"] = "BroughLike";
